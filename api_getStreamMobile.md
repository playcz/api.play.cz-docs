...
Tato metoda vrací adresu streamu. VERZE PRO MOBIL.
...
|format|načte se z globálního nastavení|požadovaný formát, je možno uvést i více hodnot oddělených znakem čárka (,)|
...
## Příklad
|/xml/getStreamMobile/bonton/wma/128|
| --- |
|/plain/getStreamMobile/?shortcut=bonton&format=mp3&bitrate=128|
|/xml/getStreamMobile/bonton/wma,mp3,aac/64|
|/plain/getStreamMobile/bonton/-/128/asx|
...
### redir
provede redir na konkrétní stream
