# OnAir data - informace o právě hrající skladbě
...
|JSON|http://onair.play.cz/json/_shortcut_.json|
| --- | --- |
|XML|http://onair.play.cz/xml/_shortcut_.xml|

## Příklad
|http://onair.play.cz/json/playuk40.json|
...
|timestamp|datum a čas aktualizace onair dat ve formátu UNIX timestamp|
